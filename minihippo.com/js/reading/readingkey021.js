...
const q3_topic = "Music show at the park";
...
const questions1 = [
  { questionStart: "I go to school by ", answerOptions: ["board", "plane", "bicycle"], questionEnd: ".", correctAnswer: "bicycle" },
  { questionStart: "The buildings in my city are very ", answerOptions: ["hate", "tall", "busy"], questionEnd: ".", correctAnswer: "tall" },
  { questionStart: "There are many green ", answerOptions: ["land", "sea", "trees"], questionEnd: " near my home.", correctAnswer: "trees" },
  ...
  { questionStart: "I do ", answerOptions: ["make", "meditation", "exercise"], questionEnd: " to feel relaxed.", correctAnswer: "meditation" }
];

/// 2. Câu 43 ( đề mới)
const question2Content = [
    { 
        text: "Flexible work models are becoming more common in modern workplaces.",
        id: "item1"
    },
    { 
        text: "Previously, employees were confined to rigid nine-to-five work hours.",
        id: "item2"
    },
    { 
        text: "Technological restrictions once made remote work a challenge.",
        id: "item3"
    },
    { 
        text: "Managers now utilize software to monitor project progress remotely.",
        id: "item4"
    },
    { 
        text: "Today, businesses are exploring shorter workweeks to boost productivity.",
        id: "item5"
    }
];
