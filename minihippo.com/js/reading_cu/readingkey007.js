...
document.getElementById('question_step').innerHTML = 'Bộ đề #007';
const q2_topic = "Solve a problem";
const q3_topic = "Submit Report";
const q4_topic = "A new restaurant";
const q5_topic = "Eating in China";
// ===============================================================================================================
// ////////////// DANH SÁCH CÂU HỎI ///////////////
// ===============================================================================================================
// 1. Câu 1
...
const questions1 = [
    { questionStart: "The books don't", answerOptions: ["balance", "fall", "stand"], questionEnd: "on the shelf.", correctAnswer: "balance" },
    { questionStart: "Could you get the financial", answerOptions: ["statement", "report", "class"], questionEnd: "for me?", correctAnswer: "statement" },
    { questionStart: "I", answerOptions: ["guess", "think", "learn"], questionEnd: "it will be useful for the project.", correctAnswer: "think" },
    { questionStart: "Read the instructions", answerOptions: ["carefully", "quickly", "slowly"], questionEnd: ", not quickly.", correctAnswer: "slowly" },
    { questionStart: "Send me the report", answerOptions: ["late", "before", "late"], questionEnd: "the meeting, not after.", correctAnswer: "before" }
];

// 2. Câu 2
const question2Content = [
    { 
        text: "The first step is to find out what you know about the problem", 
        id: "item1"
    },
    { 
        text: "The next one is to form a hypothesis or an idea based on your information", 
        id: "item2"
    },
    { 
        text: "Then, you need to perform experiments to see if these ideas are true or not", 
        id: "item3"
    },
    { 
        text: "You can also compare your results with experiments in the past", 
        id: "item4"
    },
    { 
        text: "In this way, you can add to your knowledge of the subject for future experiments", 
        id: "item5"
    }
];
// 3. Câu 3
const question3Content = [
    { 
        text: 'Before you start to write your report, you should look at websites for the information you need', 
        id: "item6"
    },
    { 
        text: "Remember to save links to websites and include them in your report", 
        id: "item7"
    },
    { 
        text: "You should also include a list of books that you use for reference", 
        id: "item8"
    },
    { 
        text: 'When you have finished your report, correct all the mistakes', 
        id: "item9"
    },
    { 
        text: "After you make the corrections, send your report by your email", 
        id: "item10"
    }
];
...
const correctAnswersQuestion4 = [  'A', 'C', 'C', 'D', 'A', 'B', 'B'];
...
strong2.innerHTML = '<strong>Mẹo nhớ Keyword:</strong> Chinese food → Influence of philosophy → Regional → Methods → Style → Changes → Effects.';

const strong3 = document.createElement('p');
strong3.innerHTML = '<strong>Nhớ theo đoạn văn:</strong> Nguồn gốc của ẩm thực trung quốc (<strong>origins of chinese food</strong>) chịu ảnh hưởng của triết học khổng tử (<strong>philosophy</strong>), sự khác biệt vùng miền (<strong>Regional</strong>) tạo nên nhiều phương pháp (<strong>methods</strong>) nấu ăn với phong cách (<strong>style</strong>) khác nhau. Sự hay đổi (<strong>Changes</strong>) chế độ ăn sẽ tạo ảnh hưởng (<strong>Effects</strong>) rất mạnh mẽ đến sức khỏe của chúng ta.';
