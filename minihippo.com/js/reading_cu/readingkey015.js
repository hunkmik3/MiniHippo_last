...
document.getElementById('question_step').innerHTML = 'Bộ đề #015';
const q2_topic = "Kelly’s journey into space";
const q3_topic = "Receive gift";
const q4_topic = "Different types of vacations (xác suất gặp đề này thấp)";
const q5_topic = "Currency";
// ===============================================================================================================
// ////////////// DANH SÁCH CÂU HỎI ///////////////
// ===============================================================================================================
// 1. Câu 1 (của câu 6 copy qua)
// 1. Câu 1
...
const question2Content = [
    { 
        text: "When she was young, she liked looking at the star and hoped to visit them", 
        id: "item1"
    },
    { 
        text: "Because of this, she studied hard at school and university", 
        id: "item2"
    },
    { 
        text: "Her hard work was successful because American Space invited", 
        id: "item3"
    },
    { 
        text: "They invited her to join the team and train", 
        id: "item4"
    },
    { 
        text: "After 1 year training, she was selected from hundreds to fly to the moon", 
        id: "item5"
    }
];
...
const question3Content = [
    { 
        text: 'Ring the bell of the gate to notify the staff of your arrival', 
        id: "item6"
    },
    { 
        text: 'Show your membership card to verify your eligibility for receiving the gift', 
        id: "item7"
    },
    { 
        text: 'Provide details of the person receiving the gift to ensure the correct recipient is identified', 
        id: "item8"
    },
    { 
        text: 'Fill in the required document to complete the necessary formalities for the gift', 
        id: "item9"
    },
    { 
        text: 'Take a seat and wait for your turn to receive the gift', 
        id: "item10"
    }
];
...
const question4Text = [
    ...
    "<strong>A:</strong> The cost of living is increasing. We need to pay attention to our lives. We have a huge variety of water. Snow or desert holidays. We’ll take you scuba-diving in the Red Sea or kayaking and white water rafting in Canada. If you prefer snow, you can try skiing or snowboarding in the Alps or even igloo-building. For those who like warmer weather, we also have sandboarding (the desert version of skateboarding) or camel safaris.",
    "<strong>B:</strong> Take a cruise to Antarctica or the northern Arctic; explore a land of white natural beauty and wonderful wildlife. Our experts will explain everything about the two poles as you watch the penguins in Antarctica or whales and polar bears in the Arctic. There’s no greater adventure than traveling to the ends of the earth. A once-in-a-lifetime experience!",
    "<strong>C:</strong> Our cultural journeys will help you discover ancient civilizations: India, Thailand, Egypt, and many more. Visit temples, palaces, and ancient ruins- just remember to bring your camera! Get to know local ways of life by exploring markets, trying exotic foods, and meeting local people.",
    "<strong>D:</strong> We have trekking holidays to famous places such as Machu Picchu or the Everest Base Camp Trek. As well as some nearer to home in the Highlands of Scotland. You don’t need to be very sporty, just fairly fit. You’ll have a great time enjoying nature with a group of new friends. Some of the holidays include camping, but we’ll provide the tents for you!",
];



const question4Content = [
    { question: "Who talked about trying exotic foods and meeting local people?", id: "question4_q1", options: ["", "A", "B", "C", "D"] },
    { question: "Who mentioned about the healthy to join the holiday?", id: "question4_q2", options: ["", "A", "B", "C", "D"] },
    { question: "Who had a great time enjoying nature with a group of new friends?", id: "question4_q3", options: ["", "A", "B", "C", "D"] },
    { question: "Who suggested bringing the shelters for tourists?", id: "question4_q4", options: ["", "A", "B", "C", "D"] },
    { question: "Who mentioned the increasing fees of cost living?", id: "question4_q5", options: ["", "A", "B", "C", "D"] },
    { question: "Who mentioned that the experts will explain everything about the two poles?", id: "question4_q6", options: ["", "A", "B", "C", "D"] },
    { question: "Who mentioned taking a cruise to explore the poles?", id: "question4_q7", options: ["", "A", "B", "C", "D"] },
];

const correctAnswersQuestion4 = ['C', 'D', 'D', 'D', 'A', 'B', 'B'];
...
strong2.innerHTML = '<strong>Mẹo nhớ Keyword:</strong> Unsatisfactory → Soft currency → Old currency → Creation → Arise → Politics → International.';

const strong3 = document.createElement('p');
strong3.innerHTML = "<strong>Nhớ theo đoạn văn:</strong> Nhà máy sản xuất (<strong>factory</strong>) tiền mềm (<strong>soft currency</strong>) và tiền cũ (<strong>old currency</strong>) đã tạo nên (<strong>creation</strong>) sự tăng trưởng (<strong>arise</strong>) về an toàn chính trị (<strong>politics</strong>) trên toàn thế giới (<strong>international</strong>).";
