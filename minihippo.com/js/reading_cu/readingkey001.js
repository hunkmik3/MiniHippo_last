...
document.getElementById('question_step').innerHTML = 'Bộ đề #001';
const q2_topic = "Natural History Center";
const q3_topic = "Traffic Lights";
const q4_topic = "Internet";
const q5_topic = "The coffee";
// ===============================================================================================================
// ////////////// DANH SÁCH CÂU HỎI ///////////////
// ===============================================================================================================
// 1. Câu 1
...
const question2Content = [
    { 
        text: "The most important of these is the Natural history centre", 
        id: "item1"
    },
    { 
        text: "The entrance of the centre is on the town's main square", 
        id: "item2"
    },
    { 
        text: "When you enter the building from the square, you will see a set of stairs to your left", 
        id: "item3"
    },
    { 
        text: "The ticket office is on the top of these stairs, the staff there are very helpful", 
        id: "item4"
    },
    { 
        text: "As well as selling tickets, they can provide maps and useful tour information", 
        id: "item5"
    }
];
// 3. Câu 3
...
const question3Content = [
    { 
        text: "They were out of order and the traffic moved very slowly", 
        id: "item6"
    },
    { 
        text: "This created long delays in the roads to the city's business district", 
        id: "item7"
    },
    { 
        text: "As a result of these delays, many people were not able to get to work on time", 
        id: "item8"
    },
    { 
        text: "Fortunately, in the evening, the traffic lights were working again", 
        id: "item9"
    },
    { 
        text: "Therefore, there were no further delays for people going back home", 
        id: "item10"
    }
];
...
const correctAnswersQuestion4 = [  'A', 'B', 'A', 'B', 'C', 'D','C'];
...
strong2.innerHTML = '<strong>Mẹo nhớ Keyword:</strong> to spread → encourages → big economy → Problems → A remedy → health → origin.';

const strong3 = document.createElement('p');
strong3.innerHTML = '<strong>Nhớ theo đoạn văn:</strong> Cà phê được sử dụng rộng rãi (<strong>to spread</strong>) ví nó thúc đẩy (<strong>encourages</strong>) nền kinh tế lớn (<strong>big economy</strong>). Tuy nhiên, vẫn còn vấn đề (<strong>Problems</strong>) bất công với người trồng cà phê ở châu Phi. Một giải pháp (<strong>A remedy</strong>) đã được đưa ra, và nếu dùng đúng cách, cà phê còn có lợi cho sức khỏe (<strong>health</strong>) như giá trị ban đầu của nó (<strong>origin</strong>).';
