...
document.getElementById('question_step').innerHTML = 'Bộ đề #004';
const q2_topic = "Hand in assignment";
const q3_topic = "Fire instructions";
const q4_topic = "Sports";
const q5_topic = "Early Australia";
// ===============================================================================================================
// ////////////// DANH SÁCH CÂU HỎI ///////////////
// ===============================================================================================================
// 1. Câu 1
...
const questions1 = [
    { questionStart: "I wake up", answerOptions: ["early", "fast", "quickly"], questionEnd: "every day.", correctAnswer: "early" },
    { questionStart: "I have", answerOptions: ["coffee", "lunch", "windows"], questionEnd: "at noon.", correctAnswer: "lunch" },
    { questionStart: "I", answerOptions: ["leave", "live", "stay"], questionEnd: "the house at 8 AM.", correctAnswer: "leave" },
    { questionStart: "I drive to work in my new", answerOptions: ["plane", "bike", "car"], questionEnd: ".", correctAnswer: "car" },
    { questionStart: "I sleep when I feel", answerOptions: ["full", "sleepy", "hungry"], questionEnd: ".", correctAnswer: "sleepy" }
];
...
const question2Content = [
    { 
        text: "First, it is a good idea to check your report and correct mistakes", 
        id: "item1"
    },
    { 
        text: "When you are sure there are no mistakes left, print out your report", 
        id: "item2"
    },
    { 
        text: "Next, complete a cover sheet with your name and your student number, and attach it to your printed assignment", 
        id: "item3"
    },
    { 
        text: "Bring your assignment with the attached cover sheet to the front desk in the main hall", 
        id: "item4"
    },
    { 
        text: "The staff member will take your report and confirm that everything is complete", 
        id: "item5"
    }
];
// 3. Câu 3
const question3Content = [
    { 
        text: 'When you hear the alarm, leave your bags and belongings at the desk', 
        id: "item6"
    },
    { 
        text: "Next, walk calmly to the doors marked Emergency Exit", 
        id: "item7"
    },
    { 
        text: "Through these doors, there are stairs leading you to the ground floor", 
        id: "item8"
    },
    { 
        text: 'When you reach the bottom of these stairs, leave the building through front entrance', 
        id: "item9"
    },
    { 
        text: "Outside, gather on the grass and wait for further instructions", 
        id: "item10"
    }
];
...
const correctAnswersQuestion4 = [  'A', 'C', 'D', 'A', 'B', 'C','D'];
...
strong2.innerHTML = '<strong>Mẹo nhớ Keyword:</strong> history → Natural → Technology → stages → A new evidence → skills → explorers';

const strong3 = document.createElement('p');
strong3.innerHTML = '<strong>Nhớ theo đoạn văn:</strong> Lịch sử (<strong>history</strong>) hình thành nước Úc diễn ra một cách tự nhiên (<strong>Natural</strong>) qua thời gian. Nhờ sự phát triển của công nghệ (<strong>Technology</strong>), con người đã khám phá ra nước Úc qua nhiều giai đoạn (<strong>stages</strong>). Những phát hiện mới (<strong>A new evidence</strong>) này không chỉ mở rộng hiểu biết mà còn giúp chúng ta học thêm các kỹ năng (<strong>skills</strong>) về thám hiểm và tìm tòi thế giới xung quanh (<strong>explorers</strong>).';
