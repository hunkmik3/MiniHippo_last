...
document.getElementById('question_step').innerHTML = 'Bộ đề #003';
const q2_topic = "A famous football player";
const q3_topic = "Growing Potatoes";
const q4_topic = "Watching a movie";
const q5_topic = "Consumer Age";
// ===============================================================================================================
// ////////////// DANH SÁCH CÂU HỎI ///////////////
// ===============================================================================================================
// 1. Câu 1
...
const questions1 = [
    { questionStart: "My colleague is", answerOptions: ["healthy", "sick", "birthday"], questionEnd: "today.", correctAnswer: "sick" },
    { questionStart: "I need to", answerOptions: ["speak", "booking", "read"], questionEnd: "a report.", correctAnswer: "read" },
    { questionStart: "I have a", answerOptions: ["party", "meeting", "break"], questionEnd: "soon.", correctAnswer: "meeting" },
    { questionStart: "The phone is", answerOptions: ["ringing", "silent", "turn"], questionEnd: ".", correctAnswer: "ringing" },
    { questionStart: "I need to", answerOptions: ["eat", "drink", "sleep"], questionEnd: "some coffee.", correctAnswer: "drink" }
];

// 2. Câu 2
const question2Content = [
    { 
        text: "When he was a child, he played for some local teams near his home in Marseille", 
        id: "item1"
    },
    { 
        text: "He then moved away from his home to join Cannes Football Club in the southern France", 
        id: "item2"
    },
    { 
        text: "While he was at that club, people throughout France saw that he was a brilliant player", 
        id: "item3"
    },
    { 
        text: "After that, he moved to Italy and Spain, where he finished his playing career", 
        id: "item4"
    },
    { 
        text: "Since he retired from playing, he has worked as a football club manager", 
        id: "item5"
    }
];
// 3. Câu 3
const question3Content = [
    { 
        text: 'All you need is some earth, an old potato and a big spot', 
        id: "item6"
    },
    { 
        text: "An old potato will have little roots, will be a little green, and won't be good for eating", 
        id: "item7"
    },
    { 
        text: "This colour means it is perfect for growing, you should put some earth in the pot and dig it deep down", 
        id: "item8"
    },
    { 
        text: "When you've done this, you should water it everyday and place it in a sunny spot", 
        id: "item9"
    },
    { 
        text: "With this care, you should see a potato plant growing after couples of weeks", 
        id: "item10"
    }
];
...
const correctAnswersQuestion4 = [  'D', 'C', 'A', 'B', 'B','D', 'A', ];
