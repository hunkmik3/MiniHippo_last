...
document.getElementById('question_step').innerHTML = 'Bộ đề #013';
const q2_topic = "Buying a new house";
const q3_topic = "Using public cycle";
const q4_topic = "Volunteering to clean a local park";
const q5_topic = "The Hotel";
// ===============================================================================================================
// ////////////// DANH SÁCH CÂU HỎI ///////////////
// ===============================================================================================================
// 1. Câu 1
...
const questions1 = [
    { questionStart: "It is", answerOptions: ["just", "only", "perfect"], questionEnd: "what I need.", correctAnswer: "just" },
    { questionStart: "And it is the perfect color,", answerOptions: ["so", "also", "too"], questionEnd: ".", correctAnswer: "too" },
    { questionStart: "I am going to wear it", answerOptions: ["for", "to", "at"], questionEnd: "my friend's party.", correctAnswer: "to" },
    { questionStart: "I will save you", answerOptions: ["two", "many", "some"], questionEnd: "cake.", correctAnswer: "some" },
    { questionStart: "I", answerOptions: ["love", "give", "show"], questionEnd: "my best wishes to everyone.", correctAnswer: "give" }
];
...
const question3Content = [
    { 
        text: "Go to the collection point and click on the screen to choose the bike with your bank card", 
        id: "item6"
    },
    { 
        text: 'Choose "hire the cycle" on the screen and then follow the instructions to receive an unlock code.', 
        id: "item7"
    },
    { 
        text: "Enter the code on the lock of the bike and wait for the green lights", 
        id: "item8"
    },
    { 
        text: "When the light comes, you can unlock your bike and start your journey", 
        id: "item9"
    },
    { 
        text: "When you finish your journey, return the bike to any empty collection point", 
        id: "item10"
    }
];
...
const correctAnswersQuestion4 = ['B', 'A', 'A', 'D', 'C', 'C', 'B'];
...
strong2.innerHTML = "<strong>Mẹo nhớ Keyword:</strong> Choice → Price → Importance → Freedom → Live → Own Space → Competitive Business.";

const strong3 = document.createElement('p');
strong3.innerHTML = "<strong>Nhớ theo đoạn văn:</strong> Việc lựa chọn (<strong>choice</strong>) một khách sạn với mức giá cả (<strong>price</strong>) hợp lý là yếu tố rất quan trọng (<strong>importance</strong>), giúp thuê được phòng mang lại sự tự do (<strong>freedom</strong>) để sống (<strong>live</strong>) trong không gian riêng (<strong>own space</strong>) của mình. Điều này tạo sự cạnh tranh trong kinh doanh (<strong>competitive business</strong>) của các khách sạn.";
