...
document.getElementById('question_step').innerHTML = 'Bộ đề #009';
const q2_topic = "Car park";
const q3_topic = "Submit Paperwork";
const q4_topic = "Eating and cooking";
const q5_topic = "Antarctica - Frozen land";
// ===============================================================================================================
// ////////////// DANH SÁCH CÂU HỎI ///////////////
// ===============================================================================================================
// 1. Câu 1
...
const questions1 = [
    { questionStart: "The sky is", answerOptions: ["clear", "running", "busy"], questionEnd: "today.", correctAnswer: "clear" },
    { questionStart: "I had an", answerOptions: ["sad", "love", "enjoyable"], questionEnd: "lunch with my friends.", correctAnswer: "enjoyable" },
    { questionStart: "After", answerOptions: ["gaming", "eat", "working"], questionEnd: "for hours, I felt tired.", correctAnswer: "working" },
    { questionStart: "I hope to", answerOptions: ["write", "read", "sing"], questionEnd: "that book soon.", correctAnswer: "read" },
    { questionStart: "The", answerOptions: ["sea", "sun", "tree"], questionEnd: "is shining brightly today.", correctAnswer: "sun" }
];
...
const question2Content = [
    { 
        text: "When you arrive, please take a ticket from a machine at the entrance", 
        id: "item1"
    },
    { 
        text: "This ticket will show the date and the time you arrived", 
        id: "item2"
    },
    { 
        text: "Please display the ticket with this information in the window of your car", 
        id: "item3"
    },
    { 
        text: "Before you leave, please put the ticket on the machine by the gate", 
        id: "item4"
    },
    { 
        text: "The machine will read your information and tell you how much you have to pay", 
        id: "item5"
    }
];
// 3. Câu 3
const question3Content = [
    { 
        text: 'In your account, press "open new window"', 
        id: "item6"
    },
    { 
        text: "When you do this, a new window will open", 
        id: "item7"
    },
    { 
        text: "Simply drag and drop your files", 
        id: "item8"
    },
    { 
        text: 'Once you put the files there, press the "send" button', 
        id: "item9"
    },
    { 
        text: "After you send your work, you should check your email", 
        id: "item10"
    }
];
...
const correctAnswersQuestion4 = [  'C', 'D', 'A', 'B', 'B', 'D', 'C'];
