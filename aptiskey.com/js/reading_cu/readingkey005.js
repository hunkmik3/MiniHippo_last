...
document.getElementById('question_step').innerHTML = 'Bộ đề #005';
const q2_topic = "A scientist’s life - Albert";
const q3_topic = "Enter the Conference Hall";
const q4_topic = "Going on holiday";
const q5_topic = "Charles Dickens";
// ===============================================================================================================
// ////////////// DANH SÁCH CÂU HỎI ///////////////
// ===============================================================================================================
// 1. Câu 1
...
const questions1 = [
    { questionStart: "My dog is", answerOptions: ["friendly", "run", "sleepy"], questionEnd: ".", correctAnswer: "friendly" },
    { questionStart: "This is the", answerOptions: ["weekend", "boring", "first"], questionEnd: "book I read.", correctAnswer: "first" },
    { questionStart: "I can", answerOptions: ["skip", "sleep", "walk"], questionEnd: "to the park.", correctAnswer: "walk" },
    { questionStart: "He can", answerOptions: ["run", "speak", "dance"], questionEnd: "English very well.", correctAnswer: "speak" },
    { questionStart: "We eat dinner", answerOptions: ["working", "alone", "together"], questionEnd: "every evening.", correctAnswer: "together" }
];
...
const question3Content = [
    { 
        text: 'When you arrive at the conference hall, give your booking number', 
        id: "item6"
    },
    { 
        text: "A staff member will note this down and give you a welcome pack", 
        id: "item7"
    },
    { 
        text: "Inside you will find a schedule of events and the information of the key speaker", 
        id: "item8"
    },
    { 
        text: 'If you would like to attend his talk, it will take place in the main hall at midday', 
        id: "item9"
    },
    { 
        text: "After he finishes, there will be time for questions", 
        id: "item10"
    }
];
...
const correctAnswersQuestion4 = [  'A', 'D', 'B', 'D', 'B', 'C','A'];
...
strong2.innerHTML = '<strong>Mẹo nhớ Keyword:</strong> Dickens → Difficulties → Guessing → Media → Success → Protect → Life.';

const strong3 = document.createElement('p');
strong3.innerHTML = '<strong>Nhớ theo đoạn văn:</strong> Dickens là nhà văn nổi tiếng với các bài văn rất khó hiểu (<strong>Difficulties</strong>) luôn làm cho người đọc phải đoán (<strong>guessing</strong>) phần tiếp theo, nhờ truyền thông (<strong>media</strong>) mà ông sớm thành công (<strong>success</strong>), ông luôn luôn bảo vệ (<strong>protect</strong>) phong cách viết của bản thân, các tác phẩm của ông sống mãi (<strong>life</strong>) với chúng ta ngày này.';
